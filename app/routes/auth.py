...
def _send_otp_email(to_email, otp_code, purpose='verify'):
    if purpose == 'reset':
        ...
        note = "You requested a password reset on Looph."
    else:
        subject = "Your Looph Verification Code"
        heading = "EMAIL VERIFICATION"
        note = "Thanks for joining Looph."
    ...
    <div style="background:#080807;padding:48px 32px;font-family:'DM Sans',Arial,sans-serif;color:#f0ede6;text-align:center;max-width:480px;margin:0 auto">
      <p style="font-family:'Cormorant Garamond',Georgia,serif;font-size:2.2rem;font-weight:300;letter-spacing:.12em;margin-bottom:.25rem">Looph</p>
    ...
    """
    text_body = f"Your Looph code: {otp_code}. Expires in 10 minutes."
