...
def generate_sale_receipt(sale):
    ...
    p.drawString(190, 730, "Timeless Fashion - POS Receipt")
...
def generate_sales_report_pdf(period_label, start_date, end_date, metrics):
    ...
    p.drawCentredString(300, 770, "ETERNO SALES REPORT")
    ...
    p.drawCentredString(300, y_position, "Generated via ETERNO Admin Dashboard")
